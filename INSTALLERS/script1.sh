...
pacstrap /mnt base linux linux-firmware grub dosfstools wget vim unzip efibootmgr bspwm zsh base-devel sddm git neovim nano archlinux-wallpaper networkmanager sudo thunar thunar-volman htop neofetch intel-ucode materia-gtk-theme papirus-icon-theme sxhkd alacritty picom --noconfirm &&
