...
pacstrap /mnt base linux linux-firmware grub dosfstools vim efibootmgr zsh base-devel sddm plasma git neovim nano networkmanager sudo htop intel-ucode --noconfirm &&
